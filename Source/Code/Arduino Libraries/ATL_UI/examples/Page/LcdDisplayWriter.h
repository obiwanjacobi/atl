 ...
 * Each uses ATL TextWriter and/or HD44780 functionality to implement it.
 ...
 */
  ...
  *
  * This class is provided as a sample. ATL has a HD44780_DisplayWriter that does exactly the same.
  */
