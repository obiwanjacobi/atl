...
namespace ATL {
    ...
    /** Represents a bounds-checked (read-only) reference to an array.
    ...
    public:
        ...
        /** Constructs an instance with a pointer to an array.
         *  \param array pointes to the array (array[]). Must not be null.
         */
        ArrayRef(T* array)
            : _arr(array)
        { }
        ...
        /** Gets the current number of items int the array.
         *  \return Returns the MaxItems template parameter.
         */
