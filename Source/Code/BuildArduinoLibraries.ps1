...
[string[]] $ATL_Files = "Array.h", "ArrayRef.h", "Bit.h", "BitArray.h", "BitFlag.h", "Collection.h", "CollectionRef.h", "Delays.h", "Delegate.h", "Func.h", "IdentifiableObject.h", "Range.h", "Ringbuffer.h", "Time.h", "ValueContainer.h", "Arduino\Time_Arduino.h"
