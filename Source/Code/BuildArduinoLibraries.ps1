...
[string[]] $ATL_Files = "Array.h", "ArrayRef.h", "Bit.h", "BitArray.h", "BitFlag.h", "Collection.h", "CollectionRef.h", "Default.h", "Delays.h", "Delegate.h", "Func.h", "IdentifiableObject.h", "Range.h", "Ringbuffer.h", "Time.h", "ValueContainer.h", "Arduino\Time_Arduino.h"
...
[string[]] $ATL_UI_Files = "Array.h", "Collection.h", "Control.h", "ControlContainer.h", "Default.h", "DisplayWriter.h", "HD44780_DisplayWriter.h", "HorizontalPanel.h", "InputControl.h", "LabelControl.h", "Line.h", "NavigationController.h", "Page.h", "PageController.h", "Panel.h", "PanelControlContainer.h", "UpDownControl.h", "VerticalPanel.h"
